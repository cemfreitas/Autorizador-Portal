 ...
 * Provides implementation for Reversal transactions (0420).
 */
public class TransactionReversal extends TransactionMediator{
	public TransactionReversal(byte[] transactionFromTerminal, Socket connection) throws IOException {
