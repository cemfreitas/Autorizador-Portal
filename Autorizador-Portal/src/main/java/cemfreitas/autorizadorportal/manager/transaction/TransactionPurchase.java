...
/*
 * TransactionPurchase class.
 * Provides implementation for Purchase transactions (0200).
 */
public class TransactionPurchase extends TransactionMediator {
	
	public TransactionPurchase(byte[] transactionFromTerminal, Socket connection) throws IOException {
