 ...
 * implementation for DES HSM database transactions. 
 */
public class TransactionHsmDESDB extends TransactionBaseDB {
	private static final String storedProcedureName = AutorizadorParams.getValue("SP_HSM_DES");	
	private Logger traceLog = Logging.getTrace();
	private Mediator mediator;

	public TransactionHsmDESDB(Mediator mediator) {		
